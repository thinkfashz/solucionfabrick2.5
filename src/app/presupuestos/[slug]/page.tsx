...
export default function PresupuestoPublicPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(250,204,21,0.12),transparent_34%),#050505] px-3 py-6 sm:px-6 sm:py-10"><PresupuestoPublicView presupuesto={budget} publicLink={publicLink} /></main>;
}
