...
export default function RadierBudgetEngineLite(){
  ...
  return <main className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top,rgba(245,158,11,.18),transparent_28rem),#08090A] p-3 text-white sm:p-5"><section className="mx-auto grid max-w-7xl gap-5 xl:grid-cols-[390px_1fr]">
