...
export function BrandMark({ size = 'md', animated = true, className = '' }: BrandMarkProps) {
  ...
  return (
    ...
    >
      ...
      <svg aria-hidden="true" className="relative z-10 overflow-visible drop-shadow-[0_0_8px_rgba(250,204,21,.28)]" width={s.icon} height={s.icon} viewBox="0 0 64 64" fill="none">
        <path d="M7 36 32 16l25 20" stroke="#facc15" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
