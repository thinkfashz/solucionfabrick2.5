 ...
 *
 * This endpoint is called by middleware on custom domains. It must be resilient:
 * if the tenant table is not ready or the domain is not registered yet, it
 * returns a safe default instead of causing noisy 404/500 loops in Vercel logs.
 */
