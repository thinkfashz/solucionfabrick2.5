  ...
  return createPortal(
    <div className="shrink-0 border-t border-white/10 bg-black/25 p-3 backdrop-blur-2xl">
      <Link
        ...
        className="group flex min-h-16 items-center gap-3 rounded-[1.35rem] border border-[#CCB196]/28 bg-[linear-gradient(135deg,rgba(182,144,108,.2),rgba(255,255,255,.055))] px-3.5 py-3 text-left shadow-[0_16px_45px_rgba(0,0,0,.22)] transition hover:-translate-y-0.5 hover:border-[#CCB196]/55 hover:bg-[#B6906C]/20"
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="block truncate text-[12px] font-black text-[#F8F0E9]">Estudio de Inspiraciones</span>
          <span className="mt-1 block truncate text-[9px] font-bold uppercase tracking-[.12em] text-[#CCB196]">Álbumes · Cloudinary · IA</span>
        </span>
