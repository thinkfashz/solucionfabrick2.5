...
const RADIER_VISUAL = 'https://res.cloudinary.com/disghf6xc/image/upload/c_limit,w_1100/f_auto/q_auto/v1788843340/radier-cutaway-v8.png';
const CEMENT_VISUAL = 'https://res.cloudinary.com/disghf6xc/image/upload/c_limit,w_900/f_auto/q_auto/v1788843298/cement-melon-especial-25kg-v8.png';
...
export default function TiendaClientV2() {
  ...
  return <div className="min-h-screen bg-[#05090C] text-white">
    ...
    <main className="pb-28 md:pb-14">
      <section className="relative isolate min-h-[560px] overflow-hidden border-b border-white/[.07] sm:min-h-[620px] lg:min-h-[650px]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[560px] max-w-[1380px] flex-col justify-end px-5 pb-9 pt-16 sm:min-h-[620px] sm:px-8 sm:pb-12 lg:min-h-[650px] lg:px-10">
