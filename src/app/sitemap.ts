...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/centro-tecnico`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    ...
    { url: `${BASE_URL}/herramientas/metalcon/monitoreo`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
