...
export const BUDGET_SERVICES: BudgetService[] = [
  {
    id: 'albanileria', category: 'Obra base', title: 'Albañilería y obra gruesa', short: 'Albañilería', unit: 'm²', measurement: 'wall', marketMin: 45000, marketMax: 95000,
  ...
  {
    id: 'cimientos', category: 'Obra base', title: 'Cimientos y fundaciones', short: 'Fundaciones', unit: 'm³', measurement: 'volume', marketMin: 145000, marketMax: 260000,
  ...
  {
    id: 'radier', category: 'Obra base', title: 'Radier de hormigón', short: 'Radier', unit: 'm²', measurement: 'slab', marketMin: 38000, marketMax: 72000,
  ...
  {
    id: 'metalcon', category: 'Construcción', title: 'Estructura Metalcon', short: 'Metalcon', unit: 'm²', measurement: 'wall', marketMin: 45000, marketMax: 85000,
  ...
  {
    id: 'ampliaciones', category: 'Construcción', title: 'Ampliación residencial', short: 'Ampliación', unit: 'm²', measurement: 'floor', marketMin: 130000, marketMax: 320000,
  ...
  {
    id: 'kit-basico', category: 'Construcción', title: 'Kit prefabricado básico', short: 'Kit básico', unit: 'm²', measurement: 'floor', marketMin: 160000, marketMax: 230000,
  ...
  {
    id: 'kit-avanzado', category: 'Construcción', title: 'Kit prefabricado avanzado', short: 'Kit avanzado', unit: 'm²', measurement: 'floor', marketMin: 320000, marketMax: 460000,
  ...
  {
    id: 'llave-mano', category: 'Construcción', title: 'Casa llave en mano estándar', short: 'Llave en mano', unit: 'm²', measurement: 'floor', marketMin: 540000, marketMax: 780000,
  ...
  {
    id: 'techumbre', category: 'Construcción', title: 'Techumbre nueva o renovación', short: 'Techumbre', unit: 'm²', measurement: 'floor', marketMin: 19990, marketMax: 75000,
  ...
  {
    id: 'gasfiteria', category: 'Instalaciones', title: 'Gasfitería y redes sanitarias', short: 'Gasfitería', unit: 'ml', measurement: 'linear', marketMin: 30000, marketMax: 75000,
  ...
  {
    id: 'electricidad', category: 'Instalaciones', title: 'Instalación eléctrica', short: 'Electricidad', unit: 'punto', measurement: 'count', marketMin: 35000, marketMax: 85000,
  ...
  {
    id: 'bano', category: 'Instalaciones', title: 'Instalación o renovación de baño', short: 'Baño', unit: 'unidad', measurement: 'count', marketMin: 900000, marketMax: 2800000,
  ...
  {
    id: 'fosa', category: 'Instalaciones', title: 'Instalación de fosa séptica', short: 'Fosa séptica', unit: 'unidad', measurement: 'count', marketMin: 1800000, marketMax: 4200000,
  ...
  {
    id: 'revestimiento', category: 'Terminaciones', title: 'Revestimiento y aislación', short: 'Revestimiento', unit: 'm²', measurement: 'wall', marketMin: 28000, marketMax: 62000,
  ...
  {
    id: 'terminaciones', category: 'Terminaciones', title: 'Terminaciones integrales', short: 'Terminaciones', unit: 'm²', measurement: 'floor', marketMin: 25000, marketMax: 70000,
  ...
  {
    id: 'pintura', category: 'Terminaciones', title: 'Pintura profesional', short: 'Pintura', unit: 'm²', measurement: 'room-walls', marketMin: 9000, marketMax: 26000,
  ...
  {
    id: 'ceramica', category: 'Terminaciones', title: 'Instalación de cerámica', short: 'Cerámica', unit: 'm²', measurement: 'floor', marketMin: 30000, marketMax: 50000,
  ...
  {
    id: 'laminado', category: 'Terminaciones', title: 'Piso laminado o flotante', short: 'Piso laminado', unit: 'm²', measurement: 'floor', marketMin: 10990, marketMax: 25000,
  ...
  {
    id: 'aire', category: 'Climatización', title: 'Instalación de aire acondicionado split', short: 'Aire acondicionado', unit: 'unidad', measurement: 'count', marketMin: 250000, marketMax: 360000,
  ...
  {
    id: 'pellet', category: 'Climatización', title: 'Instalación de estufa a pellet', short: 'Estufa a pellet', unit: 'unidad', measurement: 'count', marketMin: 120000, marketMax: 320000,
  ...
  {
    id: 'seguridad', category: 'Exterior', title: 'Seguridad residencial', short: 'Seguridad', unit: 'unidad', measurement: 'count', marketMin: 280000, marketMax: 1200000,
  ...
  {
    id: 'cierre', category: 'Exterior', title: 'Cierre perimetral', short: 'Cierre perimetral', unit: 'ml', measurement: 'linear', marketMin: 45000, marketMax: 95000,
  ...
  {
    id: 'carpinteria', category: 'Carpintería', title: 'Carpintería y muebles a medida', short: 'Carpintería', unit: 'ml', measurement: 'linear', marketMin: 250000, marketMax: 700000,
