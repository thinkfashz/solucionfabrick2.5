...
const baseCss = `
*{box-sizing:border-box}body{margin:0;font-family:Inter,Arial,sans-serif;background:#08090A;color:#FFF9EE;overflow-x:hidden}a{color:inherit;text-decoration:none}.wrap{max-width:1120px;margin:0 auto;padding:0 20px}.hero{padding:92px 0;background:radial-gradient(circle at 20% 0%,rgba(245,158,11,.24),transparent 32rem),linear-gradient(135deg,#08090A,#14100a)}.badge{display:inline-flex;border:1px solid rgba(245,158,11,.35);background:rgba(245,158,11,.12);color:#FFB000;border-radius:999px;padding:8px 12px;font-size:12px;font-weight:900;letter-spacing:.18em;text-transform:uppercase}.hero h1{font-size:clamp(38px,8vw,82px);line-height:.94;margin:20px 0 16px;letter-spacing:-.06em}.hero p{max-width:720px;color:#d6d3d1;font-size:clamp(17px,2.4vw,22px);line-height:1.7}.btns{display:flex;flex-wrap:wrap;gap:12px;margin-top:28px}.btn{border-radius:18px;padding:15px 20px;font-weight:900}.btn.primary{background:#F5871F;color:#111214}.btn.dark{border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.06)}.section{padding:70px 0}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.card{border:1px solid rgba(255,255,255,.11);background:linear-gradient(180deg,rgba(255,255,255,.08),rgba(255,255,255,.03));border-radius:26px;padding:24px}.card span{color:#FFB000;font-size:12px;font-weight:900}.card h2{font-size:24px;margin:10px 0}.card p{color:#c8c3bb;line-height:1.7}.contact{border-top:1px solid rgba(255,255,255,.1);background:#0c0a07;padding:60px 0}.contact .box{border:1px solid rgba(245,158,11,.25);background:rgba(245,158,11,.08);border-radius:30px;padding:30px}@media(max-width:800px){.grid{grid-template-columns:1fr}.hero{padding:62px 0}.section{padding:46px 0}.btns{flex-direction:column}.btn{text-align:center;width:100%}}
`;
