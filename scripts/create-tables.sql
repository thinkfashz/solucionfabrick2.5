...
ALTER TABLE public.favorites ADD COLUMN IF NOT EXISTS user_id uuid NOT NULL;
ALTER TABLE public.favorites ADD COLUMN IF NOT EXISTS product_id uuid NOT NULL;
