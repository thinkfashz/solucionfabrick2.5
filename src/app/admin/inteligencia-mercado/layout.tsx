...
import { Activity, BarChart3, Package, Search, Sparkles } from 'lucide-react';
      ...
      <div className="px-2 pt-2 sm:px-3">
        <section className="mx-auto flex max-w-[1600px] flex-col gap-3 rounded-2xl border border-black/7 bg-[#fffaf0]/95 p-3 shadow-sm backdrop-blur-xl lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0"><p className="text-[9px] font-black uppercase tracking-[.16em] text-black/30">Fabrick Market Intelligence</p><p className="truncate text-sm font-black text-[#111214]">Radar → Bandeja → Monitoreo → Product Studio</p></div>
          </div>
