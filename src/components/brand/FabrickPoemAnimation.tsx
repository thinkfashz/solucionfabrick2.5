...
export default function FabrickPoemAnimation({ compact = false, children, backgroundImageUrl = '/brand/soluciones-fabrick-dark.jpg', accentImageUrl = '/brand/soluciones-fabrick-dark.jpg', className = '' }: Props) {
