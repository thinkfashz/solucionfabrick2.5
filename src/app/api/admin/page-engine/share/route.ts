...
export async function POST(request: NextRequest) {
  ...
  const html = `<!doctype html><html lang="es"><head><meta charset="utf-8"><title>${subject}</title></head><body style="margin:0;background:#080604;color:#FFF9EE;font-family:Inter,Arial,sans-serif;padding:28px;"><div style="max-width:620px;margin:0 auto;background:linear-gradient(180deg,#111214,#090706);border:1px solid rgba(245,158,11,.28);border-radius:28px;padding:30px;box-shadow:0 30px 100px rgba(0,0,0,.35)"><p style="margin:0 0 10px;color:#FFB000;font-size:11px;letter-spacing:.24em;text-transform:uppercase;font-weight:900;">Soluciones Fabrick</p><h1 style="margin:0 0 14px;font-size:34px;line-height:1.02;letter-spacing:-.04em;color:#FFF9EE;">${title}</h1><p style="color:#d6d3d1;font-size:16px;line-height:1.7;margin:0 0 24px;">${message}</p><a href="${url}" style="display:inline-block;background:linear-gradient(135deg,#FFB000,#F5871F);color:#160b02;font-weight:900;text-decoration:none;border-radius:999px;padding:15px 22px;">Ver presentación</a><p style="margin:26px 0 0;color:#78716c;font-size:12px;">Enviado desde la plataforma con Resend API.</p></div></body></html>`;
