  ...
  return <div className="min-h-screen bg-[#060606] text-white">
    ...
    <main className="mx-auto max-w-6xl px-4 py-8 pb-28 md:px-8 lg:py-12">
      <nav className="mb-6 flex items-center justify-between gap-3 text-sm text-zinc-500">
        ...
        <button onClick={openCart} className="relative rounded-full border border-white/10 bg-white/[0.035] px-4 py-2 font-bold text-zinc-300"><ShoppingCart className="mr-2 inline h-4 w-4" /> Carrito</button>
      </nav>
      ...
      <section className="grid gap-6 lg:grid-cols-[0.96fr_1.04fr] lg:items-start">
        ...
        <article className="rounded-[2rem] border border-white/10 bg-white/[0.035] p-5 shadow-[0_28px_90px_rgba(0,0,0,.32)] md:p-7">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            ...
            <button onClick={addCurrentToCart} disabled={outOfStock} className="inline-flex min-h-[54px] flex-1 items-center justify-center rounded-2xl bg-yellow-300 px-5 text-sm font-black text-black transition hover:bg-yellow-200 disabled:opacity-40"><ShoppingCart className="mr-2 h-4 w-4" /> {added ? 'Agregado' : 'Agregar al carrito'}</button>
            <Link href={checkoutHref} className="inline-flex min-h-[54px] flex-1 items-center justify-center rounded-2xl border border-white/10 bg-white/10 px-5 text-sm font-black text-white transition hover:bg-white hover:text-black"><Zap className="mr-2 h-4 w-4" /> Comprar ahora</Link>
          </div>
