...
export const baseBudgetExample: PresupuestoPro = calculateBudget({
  id: 'presupuesto-trima-container-laboratorio', slug: 'trima-mobiliario-modular-laboratorio-container', proveedor: 'Soluciones Fabris', cliente: 'TRIMA', empresa_cliente: 'TRIMA', email_cliente: '', titulo: 'Fabricación Mobiliario Modular Laboratorio Container', ciudad: 'Chile', fecha: new Date().toISOString().slice(0, 10), validez: '5 días hábiles', plazo_entrega: '21 días hábiles', estado: 'borrador', valor_neto: 4800000, iva_porcentaje: 19, total_iva: 0, total_con_iva: 0, html_personalizado: '', usar_html_personalizado: false, json_presentacion: {}, imagenes: [], telefono_whatsapp: '', created_at: now(), updated_at: now(),
