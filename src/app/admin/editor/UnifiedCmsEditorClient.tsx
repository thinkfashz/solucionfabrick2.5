  ...
  return (
    <div className="min-h-[calc(100dvh-4rem)] bg-[#08090A] text-white">
      ...
      <div className="mx-auto max-w-[1800px]">
        ...
        {workspace === 'site' ? <div className="[&_header]:top-0"><UniversalVisualEditorClient /><VisualCmsContextEditorBridge /><VisualCmsCloudinaryBridge /><VisualCmsCloudinaryPolish /></div> : null}
        {workspace === 'ai' ? (
