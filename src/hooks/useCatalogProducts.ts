...
export const FALLBACK_CATALOG_PRODUCTS: CatalogProduct[] = [
  {
    ...
    description:
      'Sistema de acceso pensado para proteger tu hogar con apertura rápida, segura y fácil de usar.',
  ...
  },
  {
    ...
    description:
      'Iluminación adaptable para crear ambientes cálidos, modernos y eficientes en cualquier proyecto.',
    features: ['Luz cálida regulable', 'Control por WiFi', 'Bajo consumo'],
  ...
  },
  {
    ...
    description:
      'Terminación elegante, suave al tacto y preparada para resistir el uso diario sin perder presencia.',
    features: ['Fácil limpieza', 'Garantía extendida', 'Acabado premium'],
  ...
  },
  {
    ...
    description:
      'Panel decorativo con aislamiento acústico para elevar confort, silencio y calidez visual.',
