...
const products = [
  ...
  { sku: 'FAB-ADIT-1L', name: 'Aditivo impermeabilizante para hormigón 1 L', category: 'Radier', price: 10990, stock: 32, image: CONSTRUCTION, tagline: 'Apoyo para mezclas expuestas a humedad.', description: 'Aditivo líquido de referencia para mezclas de hormigón y mortero según dosificación del fabricante.', specs: { contenido: '1 L', uso: 'Hormigón y mortero', pricing: 'referencial' } },
  ...
  { sku: 'FAB-SOP-AIR', name: 'Soporte mural para unidad exterior', category: 'Climatización', price: 24990, stock: 26, image: CONSTRUCTION, tagline: 'Base firme para la condensadora.', description: 'Par de soportes metálicos para montaje mural de unidad exterior según capacidad compatible.', specs: { uso: 'Unidad exterior', pricing: 'referencial' } },
  ...
  { sku: 'FAB-LUX-PLAF', name: 'Plafón LED slim premium', category: 'Iluminación', price: 69990, stock: 14, image: LIGHTING, tagline: 'Luz limpia para espacios modernos.', description: 'Plafón LED de perfil delgado para dormitorios, pasillos y espacios de terminación contemporánea.', specs: { uso: 'Interior', tecnologia: 'LED', pricing: 'referencial' } },
];
...
INSERT INTO public.products (
  name, description, tagline, price, stock, image_url, category_id, featured, activo,
...
SELECT
  ...
  4.8, 0, ${sqlJson({ ...product.specs, seed: { origin: 'fabrick_store_seed_v1', editable: true, initialPriceOnly: true } })},
  'inherit', 'fabrick_seed', ${sqlText(sourceId)}, ${sqlText(product.sku)}, '${DEFAULT_TENANT}'::uuid, now(), now()
WHERE NOT EXISTS (
