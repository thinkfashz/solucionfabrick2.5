...
/**
 * Inbox social ‘«ˆ VERSI+ÙN MEJORADA
 *
 * Mejoras:
...
const PROVIDERS: ProviderInfo[] = [
  {
    ...
    setupSteps: [
      'Ve a Meta App Dashboard ‘Â∆ Tu App ‘Â∆ Settings ‘Â∆ Basic',
  ...
  },
  {
    ...
    setupSteps: [
      ...
      'Autoriza tu p+Ìgina de Facebook',
...
export default function SocialInboxClient() {
   ...
   function startOAuth(provider: ProviderId) {
     if (provider === 'whatsapp' || provider === 'mercadolibre') {
       alert(`OAuth para ${provider} llegar+Ì en una iteraci+¶n siguiente.`);
       return;
     }
     ...
     <div className="space-y-6">
       ...
       <section className="grid gap-3 lg:grid-cols-[260px_minmax(0,1fr)_280px]">
         ...
         <div className="rounded-2xl border border-white/10 bg-black/40 p-3 min-h-[320px]">
           ...
           <div className="flex h-[260px] items-center justify-center rounded-xl border border-dashed border-white/10 text-center">
             <p className="px-4 text-[11px] text-zinc-500">Cruzaremos remitente con la tabla `clientes` por email/tel+Æfono/handle.</p>
           </div>
         </div>
       </section>
       ...
       <p className="text-[10px] text-zinc-600">
         ...
         <code className="text-zinc-400">/api/admin/social/webhook/facebook</code> -¿ firma v+°a{' '}
