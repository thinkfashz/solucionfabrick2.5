...
<body style="margin:0;padding:0;background:#08090A;font-family:system-ui,sans-serif;color:#e5e5e5;">
  <div style="max-width:520px;margin:32px auto;padding:32px;background:#111214;border-radius:16px;border:1px solid #222;">
    ...
    <h1 style="font-size:20px;font-weight:800;color:#FFF9EE;margin:0 0 8px;">${greeting}, ¡tu plataforma está lista!</h1>
    <p style="color:#BFB8AC;font-size:14px;line-height:1.6;margin:0 0 24px;">
      <strong style="color:#FFF9EE">${params.businessName}</strong> acaba de ser activada en el plan
    ...
    <div style="background:#0d0d0d;border:1px solid #111214;border-radius:12px;padding:20px;margin-bottom:24px;">
      <div style="font-size:11px;text-transform:uppercase;letter-spacing:2px;color:#BFB8AC;margin-bottom:12px;">Tus credenciales</div>
      <div style="margin-bottom:8px;">
        <span style="color:#BFB8AC;font-size:12px;">URL del panel:</span><br>
        <a href="${adminUrl}" style="color:#10b981;font-size:13px;font-weight:600;">${adminUrl}</a>
      </div>
      <div style="margin-bottom:8px;">
        <span style="color:#BFB8AC;font-size:12px;">Email:</span><br>
        <span style="color:#FFF9EE;font-size:13px;font-weight:600;">${params.ownerEmail}</span>
      </div>
      <div>
        <span style="color:#BFB8AC;font-size:12px;">Contraseña temporal:</span><br>
        <span style="color:#FFB000;font-size:16px;font-weight:800;letter-spacing:2px;font-family:monospace;">${params.tempPassword}</span>
      </div>
    </div>
    ...
    <a href="${adminUrl}" style="display:block;text-align:center;background:#10b981;color:#08090A;font-weight:700;font-size:14px;padding:14px;border-radius:10px;text-decoration:none;margin-bottom:24px;">
      Entrar al panel →
    </a>

    <p style="color:#6E675D;font-size:12px;text-align:center;margin:0;">
      Tu tienda pública: <a href="${storeUrl}" style="color:#BFB8AC;">${storeUrl}</a>
    </p>
  </div>
</body>
</html>`;
