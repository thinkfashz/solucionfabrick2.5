...
export default function PageEngineShopifyChrome() {
  ...
  return <>
    ...
    <style jsx global>{`
      html.sf-page-engine-shopify body { background:#08090A; }
      .sf-shopify-topbar{position:sticky;top:0;z-index:58;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 16px;border-bottom:1px solid rgba(245,158,11,.16);background:rgba(7,6,4,.88);color:#FFF9EE;backdrop-filter:blur(20px);box-shadow:0 16px 50px rgba(0,0,0,.38)}
      .sf-shopify-brand{display:flex;align-items:center;gap:10px;font-weight:1000;letter-spacing:-.03em}.sf-shopify-brand svg{color:#FFB000;filter:drop-shadow(0 0 12px rgba(255, 176, 0,.5))}.sf-shopify-tools{display:flex;gap:8px;align-items:center}.sf-shopify-tools button{display:inline-flex;align-items:center;gap:7px;border:1px solid rgba(245,158,11,.22);background:rgba(245,158,11,.08);color:#FFD05A;border-radius:16px;padding:10px 12px;font-size:12px;font-weight:900}.sf-shopify-tools button:last-child{background:linear-gradient(135deg,#FFB000,#F5871F);color:#140900;border-color:transparent}
      ...
      html.sf-page-engine-shopify textarea{background:#08090A!important;border-color:rgba(245,158,11,.18)!important}html.sf-page-engine-shopify iframe{background:white!important}
